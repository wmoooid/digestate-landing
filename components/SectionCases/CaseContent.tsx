...
export const CaseContent = ({ customer = 0 }) => {
  if (customer == 0)
    return (
      <div className='case-content'>
        <div className='case-content-qoute'>
          ...
          <p className='body mb-30'>
            ...
            agreement for participation in shared construction, and then he signs all the documents at the bank and sends
            them to Rosreestr for registration.
          </p>
    ...
    return (
      <div className='case-content'>
        <div className='case-content-qoute'>
          ...
          <p className='body mb-30'>
            Convenience of the service does not increase sales by itself, but allows the developer to reduce operating costs
            and lost profits from the waiting time for payment of the DDU. Our experts estimate the economic effect of
            switching to electronic registration of equity participation agreements at the level of 38 million rubles per
            year.
          </p>
          <div className='d-flex align-center'>
